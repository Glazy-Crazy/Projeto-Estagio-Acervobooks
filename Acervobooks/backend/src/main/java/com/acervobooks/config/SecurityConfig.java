...
import com.acervobooks.security.JWTAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                    // Libera rotas de teste
                    .requestMatchers("/test/**").permitAll()
                    // Libera rotas de autenticação ANTES de qualquer outra regra
                    .requestMatchers("/auth/**").permitAll()
                    .requestMatchers("/h2-console/**").permitAll()
                    // Libera preflight CORS
                    .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                    // Libera apenas o cadastro (POST /usuarios) sem autenticação
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Em desenvolvimento, permitir explicitamente o frontend local.
        // Usar origens específicas em vez de "*" quando for necessário permitir credenciais/Authorization.
